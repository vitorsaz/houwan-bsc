...
const MOCK_TOKENS: Token[] = [
    {
        ...
        claude_score: 78,
        claude_decision: 'BUY',
        claude_reasons: ['流动性好', '市值合理', '交易量高'],
        claude_red_flags: null,
        analysis_reason: '符合买入条件',
        status: 'holding',
    ...
    },
    {
        ...
        claude_score: 72,
        claude_decision: 'BUY',
        claude_reasons: ['叙事强', '社区活跃'],
        claude_red_flags: null,
        analysis_reason: '已止盈卖出',
        status: 'sold_tp',
    ...
    },
    {
        ...
        claude_reasons: null,
        claude_red_flags: ['流动性低', '持有人少', '名称可疑'],
        analysis_reason: '风险过高',
        status: 'rejected',
    ...
    },
    {
        ...
        claude_score: 82,
        claude_decision: 'BUY',
        claude_reasons: ['市值好', '流动性高', '交易活跃'],
        claude_red_flags: null,
        analysis_reason: '正在分析中...',
        status: 'analyzing',
